    ...
    public boolean save(User user) {
        ...
        try {
            PreparedStatement statement = this.getConnection().prepareStatement(
                    "INSERT INTO users(name,password,email,phoneNumber,head,age,title,autograph) VALUES (?,?,?,?,?,?,?,?)");
            statement.setString(1, user.getName());
            statement.setString(2, user.getPassword());
            statement.setString(3, user.getEmail());
            statement.setString(4, user.getPhoneNumber());
            statement.setString(5, user.getHead());
            statement.setInt(6, user.getAge());
            statement.setString(7, user.getTitle());
            statement.setString(8, user.getAutograph());
